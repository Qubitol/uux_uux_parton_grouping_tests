...
#define ALWAYS_INLINE
          ...
          fptype allvertexes[] )
  {
    ...
    const cxtype_sv TMP0 = ( wF1[0] * ( wF2[2] * ( wV3[0] + wV3[3] ) + wF2[3] * ( wV3[1] + cI * wV3[2] ) ) + ( wF1[1] * ( wF2[2] * ( wV3[1] - cI * wV3[2] ) + wF2[3] * ( wV3[0] - wV3[3] ) ) + ( wF1[2] * ( wF2[0] * ( wV3[0] - wV3[3] ) - wF2[1] * ( wV3[1] + cI * wV3[2] ) ) + wF1[3] * ( wF2[0] * ( -wV3[1] + cI * wV3[2] ) + wF2[1] * ( wV3[0] + wV3[3] ) ) ) ) );
            ...
            ALOHAOBJ & V3 )
  {
    ...
    const cxtype_sv denom = Ccoeff * COUP / ( ( V3.pvec[0] * V3.pvec[0] ) - ( V3.pvec[1] * V3.pvec[1] ) - ( V3.pvec[2] * V3.pvec[2] ) - ( V3.pvec[3] * V3.pvec[3] ) - M3 * ( M3 - cI * W3 ) );
    wV3[0] = denom * ( -cI ) * ( wF1[0] * wF2[2] + wF1[1] * wF2[3] + wF1[2] * wF2[0] + wF1[3] * wF2[1] );
    wV3[1] = denom * ( -cI ) * ( -wF1[0] * wF2[3] - wF1[1] * wF2[2] + wF1[2] * wF2[1] + wF1[3] * wF2[0] );
    wV3[2] = denom * ( -cI ) * ( -cI * ( wF1[0] * wF2[3] + wF1[3] * wF2[0] ) + cI * ( wF1[1] * wF2[2] + wF1[2] * wF2[1] ) );
    wV3[3] = denom * ( -cI ) * ( -wF1[0] * wF2[2] - wF1[3] * wF2[1] + wF1[1] * wF2[3] + wF1[2] * wF2[0] );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
